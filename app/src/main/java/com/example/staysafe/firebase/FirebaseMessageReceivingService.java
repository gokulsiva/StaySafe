...
public class FirebaseMessageReceivingService extends FirebaseMessagingService {
    ...
    private void handleNow(Map<String, String> data) {
        ...
        String dependentName = data.get("dependentName").toString();
        String timeStamp = data.get("timeStamp").toString();;
        sendNotification(dependentName, timeStamp);
    }
     ...
     *
     */
    private void sendNotification(String dependentName, String timeStamp) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        ...
                        .setContentTitle("Are you in danger?")
                        .setContentText(dependentName + " want to know your location.")
                        .setAutoCancel(true)
